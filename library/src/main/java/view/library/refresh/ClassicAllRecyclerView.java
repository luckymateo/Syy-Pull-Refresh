 ...
 */
public class ClassicAllRecyclerView extends FrameLayout implements View.OnClickListener, ISwipeToLoadListener {
    ...
    public ClassicAllRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ClassicAllRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
