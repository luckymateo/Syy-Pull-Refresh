 ...
 */
public class ClassicPullRefreshHeaderView extends SwipeRefreshHeaderLayout {
    ...
    public ClassicPullRefreshHeaderView(Context context) {
        this(context, null);
    }

    public ClassicPullRefreshHeaderView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ClassicPullRefreshHeaderView(Context context, AttributeSet attrs, int defStyleAttr) {
